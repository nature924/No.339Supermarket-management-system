    ...
    <el-container>
        <el-header style="height: 80px">
            <el-row>
                ...
                <el-col
                    :span="12"
                    style="text-align: right; display: flex; justify-content: flex-end; align-items: center; margin-top: 15px; cursor: pointer"
                >
                    <el-dropdown>
                        <el-avatar
                            :size="50"
                        ...
                        <b
                            ...
                            font-size: 24px;
                            color: white;
                            margin-left: 10px;  /* 增加头像与文字之间的间距 */
                            line-height: 50px;  /* 文字与头像的高度一致 */
                            display: inline-block;
                            vertical-align: middle;
                            margin-top: 3px; /* 通过微调margin-top，进一步修正文字位置 */
                        "
                        >
                            {{ isAdmin ? "管理员 " : "用户 " }} {{ loginName }}
                        </b>
                ...
                >
                    ...
                    >
                        <template slot="title">
                            ...
                            >
                                <b style="font-size: 16px"> {{ item.label }}</b>
                            </i>
                        </template>
                        <el-menu-item-group>
                            <el-menu-item
