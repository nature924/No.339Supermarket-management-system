<template>
    <div id="employee_index">
        ...
        >
            ...
            >
                ...
                <el-form-item>
                    ...
                    >
                    <el-button @click="editCancel" style="font-size: 16px;">取消</el-button>
                </el-form-item>
            </el-form>
        </el-dialog>
        <!--角色列表-->
        <el-dialog title="分配职务" :visible.sync="empRoleVisable">
            ...
            <br>
            <el-button type="primary" @click="submitRoleBtn" style="font-size: 16px;">
                <i class="iconfont icon-r-yes" style="font-size: 16px;"> </i> 提交</el-button>
            <el-button @click="roleBtnCancel" style="font-size: 16px;">取消</el-button>
        </el-dialog>
        <!--重置密码-->
        <el-dialog
            title="重置密码"
        ...
        >
            <el-form>
                ...
                <el-button type="primary" @click="submitResetPwd" style="font-size: 16px;"
                    >
                    <i class="iconfont icon-r-yes" style="font-size: 16px;"> </i>
                     确定</el-button
                >
                <el-button @click="resetPwdVisable = false" style="font-size: 16px;">取消</el-button>
            </el-form>
        </el-dialog>
    </div>
</template>
