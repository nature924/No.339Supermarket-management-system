    ...
    <div id="dept_list">
        ...
        <el-row>
            <el-col :span="24" style="text-align: left">
                ...
                <el-button type="success" @click="newVisable=true"
                    style="font-size: 16px"
                >
                    <i class="iconfont icon-r-add" style="font-size: 16px">
                    </i> 创建部门
                </el-button>
            </el-col>
        </el-row>
        ...
        <el-table
            ...
            <el-table-column
                ...
                <template v-slot="scope">
                    <el-button type="success" @click="edit(scope.row)" style="font-size: 16px;">
                        <i class="iconfont icon-r-edit" style="font-size: 16px;"> </i> 修改</el-button>
                    <el-button type="danger" @click="forbidden(scope.row.id)" style="font-size: 16px;">
                        <i class="iconfont icon-r-no" style="font-size: 16px;"> </i> 停用</el-button>
                </template>
            </el-table-column>
        </el-table>
        <!--修改描述/状态弹出框-->
        <el-dialog
            ...
            <el-form v-model="editForm"  label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item>
                    ...
                    <el-button @click="canCelEdit" style="font-size: 16px;">
                        关闭</el-button>
                </el-form-item>
            </el-form>
        </el-dialog>
