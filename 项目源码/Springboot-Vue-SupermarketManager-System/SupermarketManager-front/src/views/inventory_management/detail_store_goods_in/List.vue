    ...
    <div id="detail_store_goods_in">
        ...
        <el-row>
            <el-col :span="24" style="text-align: left">
                ...
                <el-button
                    ...
                    style="font-size: 16px"
                >
                    <i class="iconfont icon-r-right" style="font-size: 16px"> </i>
                    商品入库
                </el-button>
            </el-col>
        </el-row>
                ...
                <el-table-column
                    ...
                    <template v-slot="scope">
                        <el-button type="danger" v-if="scope.row.state1=='0'"
                                   @click="del(scope.row.cn)" style="font-size: 16px;">
                                   <i class="iconfont icon-r-delete" style="font-size: 16px;"></i>
                                   删除
                        </el-button>
                    </template>
                </el-table-column>
        ...
        <el-dialog
            ...
            <el-form v-if="selectGoodsVisable" :model="selectGoods" :rules="rules" ref="selectGoods" label-width="100px"
                ...
                <el-form-item>
                    <el-button type="success" @click="selectedGoods('selectGoods')" style="font-size: 16px;">
                        <i class="iconfont icon-r-yes" style="font-size: 16px;"></i>
                        确定</el-button>
                    <el-button @click="closeSelectedGoods('selectGoods')" style="font-size: 16px;">
            ...
            <el-form v-if="newVisable" :model="newForm" :rules="rules" ref="newForm" label-width="100px"
                ...
                <el-form-item>
                    <el-button type="warning" @click="submitNewForm('newForm')" style="font-size: 16px;">
                        <i class="iconfont icon-r-right" style="font-size: 16px;"></i>
                         入库</el-button>
                    <el-button @click="saveCancel('newForm')" style="font-size: 16px;">
                         取消</el-button>
                </el-form-item>
            </el-form>
        </el-dialog>
