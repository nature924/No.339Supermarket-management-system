    ...
    <div>
        ...
        <el-row>
            <el-col :span="24" style="text-align: left">
                ...
                >
                    <i class="iconfont icon-r-find" style="font-size: 16px">
                    </i>
                    搜索</el-button
                >
                <el-button
        ...
        <el-table
            ...
            <el-table-column width="240" fixed="right"
                    label="操作">
                <template v-slot="scope">
                    <el-button type="success" style="font-size: 16px;" @click="editStore(scope.row)">
                        <i class="iconfont icon-r-edit" style="font-size: 16px;"> </i>
                         修改
                    </el-button>
                    <el-button  style="font-size: 16px;" type="danger" @click="forbidden(scope.row.id)">
                        <i class="iconfont icon-r-no" style="font-size: 16px;"> </i>
                         停用
                    </el-button>
                </template>
            </el-table-column>
        ...
        <el-dialog
            ...
            <el-form v-model="editForm" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item>
                    <el-button type="primary" @click="submitEditForm" style="font-size: 16px;">
                        <i class="iconfont icon-r-yes" style="font-size: 16px;"> </i>
                         提交
                    </el-button>
                    <el-button  style="font-size: 16px;" @click="editCancel">取消</el-button>
                </el-form-item>
            </el-form>
        </el-dialog>
        <!--创建仓库弹出框-->
        <el-dialog
            ...
            <el-form :model="newForm" :rules="rules" ref="newForm" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item>
                    <el-button type="primary" @click="submitNewForm('newForm')" style="font-size: 16px;">
                        <i class="iconfont icon-r-yes" style="font-size: 16px;"> </i> 提交</el-button>
                    <el-button @click="saveCancel" style="font-size: 16px;">取消</el-button>
                </el-form-item>
            </el-form>
        </el-dialog>
    </div>
