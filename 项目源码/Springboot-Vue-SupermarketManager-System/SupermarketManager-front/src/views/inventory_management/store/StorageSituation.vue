    ...
    <div>
        ...
        >
            <el-row>
                ...
                <el-col :span="8">
                    <el-button type="success" @click="submitDetailSearchForm" style="font-size: 16px;"
                        >
                        <i class="iconfont icon-r-find" style="font-size: 16px;"></i>
                         搜索</el-button
                    >
                    <el-button @click="closeDetailStoreVisible" style="font-size: 16px;"
                        >
